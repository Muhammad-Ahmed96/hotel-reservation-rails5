...
class ReservationsTest < ApplicationSystemTestCase
  ...
  test "should create reservation" do
    ...
    fill_in "Addition information", with: @reservation.addition_information
    fill_in "Date", with: @reservation.date
    fill_in "Name", with: @reservation.name
    fill_in "Number of tables", with: @reservation.number_of_tables
    fill_in "Seating capacity", with: @reservation.seating_capacity
